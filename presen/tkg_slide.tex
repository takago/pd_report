...
% 以下は（必要に応じて調整）
% \setlist[description]{topsep=3pt,parsep=0pt,partopsep=0pt,itemsep=2mm,leftmargin=1zw}
% \setlist[enumerate]{topsep=3pt,parsep=0pt,partopsep=0pt,itemsep=2mm,leftmargin=1zw,labelsep=*}
% \setlist[itemize]{topsep=3pt,parsep=0pt,partopsep=0pt,itemsep=2pt,leftmargin=1zw}
